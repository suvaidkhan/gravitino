...
import org.apache.gravitino.cli.commands.RemoveAllRolesFromUser;
...
public class TestableCommandLine {
  ...
  protected RemoveAllRolesFromUser newRemoveAllRolesFromUser(
      String url, boolean ignore, String metalake, String user) {
    return new RemoveAllRolesFromUser(url, ignore, metalake, user);
  }
  ...
  protected RemoveAllRolesFromGroup newRemoveAllRolesFromGroup(
      String url, boolean ignore, String metalake, String group) {
    return new RemoveAllRolesFromGroup(url, ignore, metalake, group);
  }
